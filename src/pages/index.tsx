...
import { Seo, Row, MyLink, Container, Layout } from 'src/components'
        ...
        <Container>
          ...
          <Row>
            ...
            <List>
              ...
              <ListItem>
                반복되거나 중복되는 작업 및 코드를 간소화 시키는 작업을 좋아합니다.
              </ListItem>
              ...
              <Box className="flex flex-col md:flex-row gap-16">
                ...
                <Box className="flex-1">
                  ...
                  <Box>
                    ...
                    <List className="mb-10">
                      <ListItem>
                        Button, Input, Textarea, Modal 등 UI 간의 일관성을 맞추고 생산성을 향상을
                        위해 UI 컴포넌트를 라이브러리화하여 NPM 배포
                      </ListItem>
                  ...
                  <Box>
                    ...
                    <List className="mb-10">
                      <ListItem>
                        생산성 향상을 위해 코딩 컨벤션 및 폴더, 컴포넌트 구조 정립
                      </ListItem>
                      ...
                      <ListItem>
                        Github Action을 이용하여 APK 빌드 및 PlayStore 배포 자동화
                      </ListItem>
                    </List>
                  ...
                  <Box>
                    ...
                    <Heading type="h5">Description</Heading>
                    <Paragraph className="mb-4">
                      선박안에 있는 화물창의 온/습도를 모니터링 할 수 있으며, 공조기를 제어하여
                      원하는 온/습도로 맞출 수 있는 시스템입니다.
                    </Paragraph>
